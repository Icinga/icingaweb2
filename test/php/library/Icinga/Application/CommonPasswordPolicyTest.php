...
class CommonPasswordPolicyTest extends TestCase
{
    public function testValidatePasswordTooShort(): void
    {
        $this->assertSame(
            ...
            (new CommonPasswordPolicy())->validate(new User('icingaadmin'), 'Icinga1#')
        );
    }
    ...
    {
        $this->assertEmpty((new CommonPasswordPolicy())->validate(new User('icingaadmin'), 'Icingaadmin1#'));
    }
    ...
    public function testValidatePasswordOnlyLowerCaseLetters(): void
    {
        ...
        $this->assertSame($expected, (new CommonPasswordPolicy())->validate(new User('icingaadmin'), 'icingawebadmin'));
    }
    ...
    public function testValidatePasswordToShortAndOnlyUpperCaseLetters(): void
    {
        ...
        $this->assertSame($expected, (new CommonPasswordPolicy())->validate(new User('icingaadmin'), 'ICINGAADMIN'));
    }
}
